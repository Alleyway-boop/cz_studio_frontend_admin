...
" clearable size="small" @keyup.enter.native="handleQuery" />
      ...
      <el-form-item label="发布时间" prop="publishDatetime">
        <el-date-picker clearable size="small" v-model="queryParams.publishDatetime" type="date"
          value-format="yyyy-MM-dd" placeholder="选择发布时间">
        </el-date-picker>
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['team:news:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['team:news:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['team:news:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['team:news:export']">导出</el-button>
      </el-col>
...
<el-table-column label="操作" align="center" class-name="small-padding fixed-width">
  <template slot-scope="scope">
    ...
    <el-table :data="newsList" style="width: 100%">
      ...
      <el-table-column prop="tiele" label="标题" width="120" />
      <el-table-column prop="content" label="内容" width="120" />
      <el-table-column prop="publishDatetime" label="发布时间" width="120" />
      <el-table-column fixed="right" label="发布者" min-width="120" />
...
" />
        ...
        <el-form-item label="发布时间" prop="publishDatetime">
          <el-date-picker clearable size="small" v-model="form.publishDatetime" type="date" value-format="yyyy-MM-dd"
            placeholder="选择发布时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="发布者" prop="publisher">
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('team/news/export', {
        ...this.queryParams
